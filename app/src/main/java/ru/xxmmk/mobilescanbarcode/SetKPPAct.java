...
//        String[] data = {"КПП не указана", "Проходная 1", "Проходная 2", "Проходная 3", "Проходная 4", "Склад 50" , "ЭСПЦ Пост1"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // выделяем элемент
        if (mMobileBCRApp.SKDKPP!="Укажите КПП")
        {
              spinner.setSelection(Arrays.asList(data).indexOf(mMobileBCRApp.SKDKPP));
        ...
        Okbutton.setOnClickListener(new View.OnClickListener() {
                                          ...
                                          public void onClick(View view) {
                                              if (!"КПП не указана".equals(kpp)) {
                                                  ...
                                                  mMobileBCRApp.SKDKPP = kpp;
                                                  mMobileBCRApp.SKDStep = "3";
                                                  finish();
                                              }
                                              else
                                              {
                                              ...
                                              //mmMobileBCRApp.SKDKPP=spinner.getSelectedItem().toString();
    ...
    public void GetKpp ()
    {
        ...
        mMobileBCRApp.NetErr=false;
            ...
            try {
                ...
                HttpGet httpGet = new HttpGet(mMobileBCRApp.ListKPP);
                Log.d(mMobileBCRApp.getLOG_TAG(), mMobileBCRApp.ListKPP);
                try {
             //       Log.d("kpp_name","1");
